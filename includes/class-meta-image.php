...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'abmt_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( abmt_acf_options() ) {
			...
			$blog_image    = get_field( 'abmt_meta_blog_image', 'option' );
			$default_image = get_field( 'abmt_meta_default_image', 'option' );
