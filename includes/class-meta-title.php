...
class Meta_Title {
	...
	public function __construct() {
		...
		add_action( 'abmt_meta_title_tag', [ $this, 'title' ] );
	...
	public function title() {
		...
		$author_meta = apply_filters( 'abmt_author_meta_title', $author_title );
		...
		$search_meta = apply_filters( 'abmt_search_meta_title', $search_title );
