...
class Meta_Description {
	...
	public function __construct() {
		...
		add_action( 'abmt_meta_description_tag', [ $this, 'description' ] );
	...
	public function description() {
		...
		if ( abmt_acf_options() ) {
			 ...
			 */
			$acf_blog_desc = get_field( 'abmt_meta_blog_description', 'option' );
			...
			$wp_blog_desc = get_option( 'abmt_meta_blog_description' );
		...
		$search_meta_desc = apply_filters( 'abmt_meta_description_search', $search_desc );
		...
		$meta_description = apply_filters( 'abmt_meta_description', $description );
 ...
 */
function abmt_meta_description() {
